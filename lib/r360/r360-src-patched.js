/*
 Route360° JavaScript API v0.0.9 (7470f07), a JS library for leaflet maps. http://route360.net
    ...
    onAdd: function (map) {
        ...
        $(that.slider).slider({
            ...
            slide: function (e, ui) {
                ...
                that.options.slideMove(ui.value);
            },
            stop: function(e, ui){
    ...
    onAdd: function (map) {
        ...
        $(this.options.travelTimeSlider).slider({
            ...
            slide: function (e, ui) {
                ...
                that.options.onSlideMove(ui.value);
            },
            stop: function(e, ui){
